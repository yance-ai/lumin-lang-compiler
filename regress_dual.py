...
SKIP_LIST = {
    ...
    "class_inherit_test.lm", "class_super_test.lm", "class_polymorphism_test.lm",
    "class_constructor_test.lm", "class_multi_param_test.lm", "class_super_ctor_test.lm", "class_comprehensive_test.lm", "class_interface_test.lm", "class_interface_full_test.lm", "class_interface_missing_test.lm",  # CC模式暂不支持class，VM模式已通过
}
